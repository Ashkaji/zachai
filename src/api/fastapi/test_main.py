...
def _make_mock_snapshot(payload_key_json="snapshots/1/latest.json", payload_key_docx="snapshots/1/latest.docx"):
    snap = MagicMock()
...
class _FakeRedisBible:
    """Minimal async Redis stub for verse cache tests (get/setex/delete/incr)."""
